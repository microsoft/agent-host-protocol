...
public enum ActionType
{
    ...
    [WireValue("accounts/set")]
    AccountSet,
    [WireValue("accounts/removed")]
    AccountRemoved,
    [WireValue("accounts/authAttemptSet")]
    AuthAttemptSet,
    [WireValue("accounts/authAttemptRemoved")]
    AuthAttemptRemoved,
}
...
/// <summary>Upsert a complete account by id, appending or replacing it in place.
///
...
/// Credential authority changes atomically, regardless of action delivery.</summary>
public sealed record AccountSetAction
{
    public ActionType Type { get; init; }

    /// <summary>Complete account entry.</summary>
    public required HostAccount Account { get; init; }
}

/// <summary>Remove one account lifetime and its consumer selections by id.
///
...
/// of an absent id is an accepted no-op, not removal of another account.</summary>
public sealed record AccountRemovedAction
{
    public ActionType Type { get; init; }

    /// <summary>Host-issued account lifetime to retire. No resource or token precondition.</summary>
    public required string Id { get; init; }
}

/// <summary>Upsert a complete admission by id, appending or replacing it in place.
///
/// Only the host may publish pending, completed, or failed admission state.</summary>
public sealed record AuthAttemptSetAction
{
    public ActionType Type { get; init; }

    /// <summary>Complete admission entry.</summary>
    public required AuthAttemptState Attempt { get; init; }
}

/// <summary>Cancel a pending admission, or let the host discard a retained outcome.
///
...
/// reconciliation, an absent attempt cannot own a still-live account lifetime.</summary>
public sealed record AuthAttemptRemovedAction
{
    public ActionType Type { get; init; }

    /// <summary>Host-issued attempt id.</summary>
    public required string Id { get; init; }
}
...
internal sealed class StateActionConverter : UnionConverter<StateAction>
{
    public StateActionConverter()
        : base(
            ...
            {
        ["accounts/set"] = typeof(AccountSetAction),
        ["accounts/removed"] = typeof(AccountRemovedAction),
        ["accounts/authAttemptSet"] = typeof(AuthAttemptSetAction),
        ["accounts/authAttemptRemoved"] = typeof(AuthAttemptRemovedAction),
