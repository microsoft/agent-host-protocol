...
export const ACTION_INTRODUCED_IN: { readonly [K in StateAction['type']]: string } = {
  ...
  [ActionType.SessionCanvasesChanged]: '0.5.2',
  [ActionType.SessionOpenCanvasesChanged]: '0.5.2',
  [ActionType.CanvasUpdated]: '0.5.2',
  [ActionType.CanvasCloseRequested]: '0.5.2',
  [ActionType.CanvasMessage]: '0.5.2',
};
