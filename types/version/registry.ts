...
export const ACTION_INTRODUCED_IN: { readonly [K in StateAction['type']]: string } = {
  ...
  [ActionType.SessionCanvasRegistryChanged]: '0.5.0',
  [ActionType.SessionCanvasInstanceOpened]: '0.5.0',
  [ActionType.SessionCanvasInstanceUpdated]: '0.5.0',
  [ActionType.SessionCanvasInstanceClosed]: '0.5.0',
  [ActionType.SessionCanvasInstanceCloseRequested]: '0.5.0',
  [ActionType.SessionCanvasRequestCreated]: '0.5.0',
  [ActionType.SessionCanvasRequestCompleted]: '0.5.0',
  [ActionType.SessionCanvasRequestCancelled]: '0.5.0',
