...
const ACTION_VARIANTS: { type: string; caseName: string; tsInterface: string }[] = [
  ...
  { type: 'chat/backgroundShellSet', caseName: 'chatBackgroundShellSet', tsInterface: 'ChatBackgroundShellSetAction' },
  { type: 'chat/backgroundShellRemoved', caseName: 'chatBackgroundShellRemoved', tsInterface: 'ChatBackgroundShellRemovedAction' },
