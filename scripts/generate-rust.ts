...
const STATE_STRUCTS: { name: string; omitDiscriminants?: boolean; rustName?: string }[] = [
  ...
  { name: 'ToolResultTerminalCompleteContent', omitDiscriminants: true },
...
const TOOL_RESULT_CONTENT_UNION: UnionConfig = {
  ...
  variants: [
    ...
    { variantName: 'TerminalComplete', innerType: 'ToolResultTerminalCompleteContent', wireValue: 'terminalComplete' },
...
const ACTION_VARIANTS: {
  ...
  { type: 'changeset/filesReviewedChanged', variantName: 'ChangesetFilesReviewedChanged', tsInterface: 'ChangesetFilesReviewedChangedAction' },
